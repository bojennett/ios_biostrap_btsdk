...
@interface Device (SWIFT_EXTENSION(kairosBTSDK)) <CBPeripheralDelegate>
...
- (void)manufacturingTest:(NSString * _Nonnull)id test:(enum kairosManufacturingTestType)test SWIFT_DEPRECATED_MSG("Send commands to the Device object directly.  This will be removed in a future version of the SDK");
