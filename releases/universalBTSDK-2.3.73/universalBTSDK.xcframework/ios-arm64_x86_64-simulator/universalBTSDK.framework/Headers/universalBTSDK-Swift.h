...
@property (nonatomic, readonly, copy) NSString * _Nonnull medtorSoftwareRevision;
...
@property (nonatomic, copy) void (^ _Nullable debugComplete)(NSString * _Nonnull, BOOL, enum debugDevice, NSData * _Nonnull);
...
@property (nonatomic, copy) void (^ _Nullable motorComplete)(NSString * _Nonnull, BOOL);
...
@property (nonatomic, copy) void (^ _Nullable startLiveSyncComplete)(NSString * _Nonnull, BOOL);
@property (nonatomic, copy) void (^ _Nullable stopLiveSyncComplete)(NSString * _Nonnull, BOOL);
...
@property (nonatomic, copy) void (^ _Nullable pulseOx)(NSString * _Nonnull, float, float);
...
- (void)debug:(NSString * _Nonnull)id device:(enum debugDevice)device data:(NSData * _Nonnull)data;
...
- (void)livotalLED:(NSString * _Nonnull)id red:(BOOL)red green:(BOOL)green blue:(BOOL)blue blink:(BOOL)blink seconds:(NSInteger)seconds;
- (void)ethosLED:(NSString * _Nonnull)id red:(NSInteger)red green:(NSInteger)green blue:(NSInteger)blue mode:(enum ethosLEDMode)mode seconds:(NSInteger)seconds percent:(NSInteger)percent;
- (void)alterLED:(NSString * _Nonnull)id red:(BOOL)red green:(BOOL)green blue:(BOOL)blue blink:(BOOL)blink seconds:(NSInteger)seconds;
- (void)kairosLED:(NSString * _Nonnull)id red:(BOOL)red green:(BOOL)green blue:(BOOL)blue blink:(BOOL)blink seconds:(NSInteger)seconds;
- (void)motor:(NSString * _Nonnull)id milliseconds:(NSInteger)milliseconds pulses:(NSInteger)pulses;
...
- (void)livotalManufacturingTest:(NSString * _Nonnull)id;
- (void)ethosManufacturingTest:(NSString * _Nonnull)id test:(enum ethosManufacturingTestType)test;
- (void)alterManufacturingTest:(NSString * _Nonnull)id test:(enum alterManufacturingTestType)test;
- (void)kairosManufacturingTest:(NSString * _Nonnull)id test:(enum kairosManufacturingTestType)test;
- (void)startLiveSync:(NSString * _Nonnull)id configuration:(liveSyncConfiguration * _Nonnull)configuration;
- (void)stopLiveSync:(NSString * _Nonnull)id;
