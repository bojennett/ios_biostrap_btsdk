...
#ifndef ALTERBTSDK_SWIFT_H
#define ALTERBTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="alterBTSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10alterBTSDK6Device")
...
@interface Device (SWIFT_EXTENSION(alterBTSDK)) <CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC10alterBTSDK18biostrapDataPacket")
...
SWIFT_CLASS("_TtC10alterBTSDK17biostrapDeviceSDK")
...
@property (nonatomic, readonly, copy) NSArray<Device *> * _Nonnull unnamedDevices;
@property (nonatomic, readonly, copy) NSArray<Device *> * _Nonnull connectedDevices;
@property (nonatomic, copy) void (^ _Nullable logV)(NSString * _Nullable, NSString * _Nonnull, NSString * _Nonnull, NSInteger) SWIFT_DEPRECATED_MSG("Use the 'log' PassthroughSubject.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable logD)(NSString * _Nullable, NSString * _Nonnull, NSString * _Nonnull, NSInteger) SWIFT_DEPRECATED_MSG("Use the 'log' PassthroughSubject.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable logI)(NSString * _Nullable, NSString * _Nonnull, NSString * _Nonnull, NSInteger) SWIFT_DEPRECATED_MSG("Use the 'log' PassthroughSubject.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable logW)(NSString * _Nullable, NSString * _Nonnull, NSString * _Nonnull, NSInteger) SWIFT_DEPRECATED_MSG("Use the 'log' PassthroughSubject.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable logE)(NSString * _Nullable, NSString * _Nonnull, NSString * _Nonnull, NSInteger) SWIFT_DEPRECATED_MSG("Use the 'log' PassthroughSubject.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable bluetoothReady)(BOOL) SWIFT_DEPRECATED_MSG("Use the published bluetoothAvailable property.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable discovered)(NSString * _Nonnull, Device * _Nonnull) SWIFT_DEPRECATED_MSG("Use the published discoverdDevices property.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable discoveredUnnamed)(NSString * _Nonnull, Device * _Nonnull) SWIFT_DEPRECATED_MSG("Use the published unnamedDevices property.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable connected)(NSString * _Nonnull) SWIFT_DEPRECATED_MSG("Use the published connectedDevices property.  This will be removed in a future version of the SDK");
@property (nonatomic, copy) void (^ _Nullable disconnected)(NSString * _Nonnull) SWIFT_DEPRECATED_MSG("Use the 'deviceDisconnected' PassthroughSubject.  This will be removed in a future version of the SDK");
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (BOOL)startScan SWIFT_WARN_UNUSED_RESULT;
- (BOOL)startScanWithParametersInBackground:(BOOL)inBackground forPaired:(BOOL)forPaired forUnpaired:(BOOL)forUnpaired forLegacy:(BOOL)forLegacy SWIFT_WARN_UNUSED_RESULT;
- (void)stopScan;
- (void)connect:(NSString * _Nonnull)id SWIFT_DEPRECATED_MSG("Use the device object's connect function directly.  This will be removed in a future version of the SDK");
- (void)disconnect:(NSString * _Nonnull)id SWIFT_DEPRECATED_MSG("Use the device object's connect function directly.  This will be removed in a future version of the SDK");
...
- (void)userLED:(NSString * _Nonnull)id red:(BOOL)red green:(BOOL)green blue:(BOOL)blue blink:(BOOL)blink seconds:(NSInteger)seconds SWIFT_DEPRECATED_MSG("Send commands to the Device object directly.  This will be removed in a future version of the SDK");
...
- (void)manufacturingTest:(NSString * _Nonnull)id test:(enum alterManufacturingTestType)test SWIFT_DEPRECATED_MSG("Send commands to the Device object directly.  This will be removed in a future version of the SDK");
...
- (void)runSessionFile:(NSString * _Nonnull)id file:(NSURL * _Nonnull)file offset:(NSInteger)offset;
@end
...
@interface biostrapDeviceSDK (SWIFT_EXTENSION(alterBTSDK)) <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC10alterBTSDK23biostrapStreamingPacket")
...
SWIFT_CLASS("_TtC10alterBTSDK25ppgAlgorithmConfiguration")
